...
import EgresoXSemana from "./GraficaEgresoXSemana";
import DonaEgresoVentadia from "./GraficaEgresoXDia";
import CalendarMonthIcon from "@mui/icons-material/CalendarMonth";
import GraficaBarrasXDia from "./GraficaBarrasxDia";
import DonaEgresoUltimaSemana from "./GraficaDonaXSemana";
import EgresoXPeriodo from "./GraficaBarrasXPeriodo";
import DonaEgresoPeriodo from "./GraficaDonaXPeriodo";
...
const Egresos = () => {
   ...
   const fetchData = async () => {
     try {
       ...
       sortedData.sort((a, b) => a.fecha_dia - b.fecha_dia);
   
       // Calcular el total de ventas para la semana
       const total = sortedData.reduce((accumulatedTotal, currentItem) => accumulatedTotal + currentItem.egreso_hora, 0);
   ...
   const fetchData2 = async () => {
     try {
       const response = await fetch(`http://5.189.133.32:9060/datasnap/rest/TServerMethods/EgresoPeriodos/${datos.EMP_TERCERO}`, 
       {
         method: "GET",
         headers: {
           "Content-Type": "application/json",
   ...
   const fetchData3 = async () => {
     try {
       const response = await fetch(`http://5.189.133.32:9060/datasnap/rest/TServerMethods/EgresoxHora/${datos.EMP_TERCERO}`, {
         method: "GET",
         headers: {
           "Content-Type": "application/json",
           // Puedes incluir aquí el token si es necesario
       ...
       // Calcula la suma total del período
       const total = responseData.reduce((accumulatedTotal, currentItem) => accumulatedTotal + currentItem.egreso_hora, 0);
    ...
    <>
      <main className="main users chart-page" id="skip-target">
        <div className="container">
          <h2 className="main-title">Egresos</h2>
          ...
          <div className="col-md-6 col-xl-3 " id="cards-1">
              ...
              >
                ...
                <div>
                  <br />
                  <p>
                    Total egresos del dia: ${totalVentaxHora.toLocaleString()}
                  </p>
                  <br />
            ...
            <div className="col-md-6 col-xl-3 ">
              ...
              >
                ...
                <div>
                  <br />
                  <p>
                    Total egresos última semana: ${totalsemana.toLocaleString()}
                  </p>
                  <br />
                  {/*  {data ? (
                    data.map((item, index) => (
